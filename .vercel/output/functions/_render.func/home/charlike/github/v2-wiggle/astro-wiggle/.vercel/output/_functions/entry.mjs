...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from './manifest_C0Abboha.mjs';
import { e as appendForwardSlash, j as joinPaths, t as trimSlashes, s as slash, p as prependForwardSlash, r as removeTrailingForwardSlash, f as collapseDuplicateSlashes } from './chunks/astro/assets-service_Dp7f4sQr.mjs';
import { R as ROUTE_DATA_SYMBOL, A as AstroError, l as ResponseSentError, n as MiddlewareNoDataOrNextCalled, o as MiddlewareNotAResponse, G as GetStaticPathsRequired, p as InvalidGetStaticPathsReturn, q as InvalidGetStaticPathsEntry, t as GetStaticPathsExpectedParams, u as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, N as NoMatchingStaticPathFound, v as PrerenderDynamicEndpointPathCollide, w as LocalsNotAnObject, x as ASTRO_VERSION, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, y as renderEndpoint, z as ReservedSlotName, B as renderSlotToString, D as renderJSX, H as chunkToString, J as CantRenderPage, K as renderPage$1, O as REROUTE_DIRECTIVE_HEADER } from './chunks/astro_bHY3mzoH.mjs';
...
const _page0 = () => import('./chunks/generic_DCaC7FR3.mjs');
const _page1 = () => import('./chunks/_input__ZrKyQeUw.mjs');
const _page2 = () => import('./chunks/index_DMdOm-6r.mjs');
const _page3 = () => import('./chunks/index_Ci-rznac.mjs');
const _page4 = () => import('./chunks/index_DTciJLpr.mjs');
const _page5 = () => import('./chunks/index_Bbau4e9x.mjs');
const _page6 = () => import('./chunks/index_CaSicV_r.mjs');
const _page7 = () => import('./chunks/index_BpqUFpjl.mjs');
const _page8 = () => import('./chunks/index_B2vCtems.mjs');
const _page9 = () => import('./chunks/index_DCGnsf1Y.mjs');
const _page10 = () => import('./chunks/index_D-Y0LlUB.mjs');
const _page11 = () => import('./chunks/index_CkmhJO90.mjs');
const _page12 = () => import('./chunks/index_h41Kzbz8.mjs');
const _page13 = () => import('./chunks/index_BUnwnxL3.mjs');
const _page14 = () => import('./chunks/_id__CFjjEjlB.mjs');
const _page15 = () => import('./chunks/404_7Th-JA0M.mjs');
const _page16 = () => import('./chunks/_input__DNH-B_yj.mjs');
const _page17 = () => import('./chunks/_input__CI-keEV3.mjs');
const _page18 = () => import('./chunks/index_hhrZuOB_.mjs');
const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/address/[input].astro", _page1],
    ["src/pages/api/ethscriptions/[id]/content/index.ts", _page2],
    ["src/pages/api/ethscriptions/[id]/creator/index.ts", _page3],
    ["src/pages/api/ethscriptions/[id]/number/index.ts", _page4],
    ["src/pages/api/ethscriptions/[id]/owner/index.ts", _page5],
    ["src/pages/api/ethscriptions/[id]/transfers/index.ts", _page6],
    ["src/pages/api/ethscriptions/[id]/index.ts", _page7],
    ["src/pages/api/ethscriptions/index.ts", _page8],
    ["src/pages/api/exists/index.ts", _page9],
    ["src/pages/api/resolve/[user]/created/index.ts", _page10],
    ["src/pages/api/resolve/[user]/owned/index.ts", _page11],
    ["src/pages/api/resolve/[user]/index.ts", _page12],
    ["src/pages/api/search/[input]/index.ts", _page13],
    ["src/pages/api/txs/[id].ts", _page14],
    ["src/pages/pages/404.astro", _page15],
    ["src/pages/tx/[input].astro", _page16],
    ["src/pages/[input].astro", _page17],
...
const _args = {
    "middlewareSecret": "0659ec44-8297-47ca-92b3-f7aef06fc213"
};
